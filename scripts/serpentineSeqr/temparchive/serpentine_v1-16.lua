...
local function draw_alt()
  ...
  for x=1,8 do spx(x,2,10,5,15) end
  for x=9,16 do
  ...
  elseif alt_disp_timer > 0 and alt_disp_mode == "RAN" then
    ...
    if hum_flash > 0 then
      ...
      draw_label(8,4,humanize_on and"ACT"or"OFF",humanize_on and 20 or 200,humanize_on and 200 or 40,humanize_on and 220 or 40,2)
    else
